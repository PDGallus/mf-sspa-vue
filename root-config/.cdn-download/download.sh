...
curl -O https://cdn.jsdelivr.net/npm/vue@3.5.18/dist/vue.runtime.global.prod.min.js
curl -O https://cdn.jsdelivr.net/npm/vue-router@4.5.1/dist/vue-router.global.prod.min.js
